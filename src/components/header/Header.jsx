        ...
        <div className='position-relative overflow-hidden header-height'>
            <nav className="navbar navbar-expand-lg navbar-light ">
                    <svg width="60" height="48" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15.1812 10.4729V9.12035C15.1812 9.05388 15.235 9 15.3015 9C15.368 9 15.4219 9.05388 15.4219 9.12035V10.4729C15.4219 10.5394 15.368 10.5933 15.3015 10.5933C15.235 10.5933 15.1812 10.5394 15.1812 10.4729Z" fill="black" stroke="#FFD0B5" stroke-width="0.5"/>
                        <path d="M12.2356 11.1997L11.6281 10.0389C11.5964 9.97843 11.6174 9.89969 11.675 9.86303C11.7326 9.82636 11.8049 9.84566 11.8365 9.90612L12.444 11.067C12.4756 11.1274 12.4546 11.2062 12.3971 11.2428C12.3395 11.2795 12.2672 11.2602 12.2356 11.1997Z" fill="black" stroke="#FFD0B5" stroke-width="0.5"/>
                        <path d="M18.1268 11.067L18.7343 9.90612C18.7659 9.84566 18.8382 9.82636 18.8958 9.86302C18.9533 9.89969 18.9743 9.97843 18.9427 10.0389L18.3352 11.1997C18.3036 11.2602 18.2313 11.2795 18.1737 11.2428C18.1161 11.2062 18.0951 11.1274 18.1268 11.067Z" fill="black" stroke="#FFD0B5" stroke-width="0.5"/>
                    </svg>
